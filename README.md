...
$VEC=\sum_{i=1}^{n}C_{i}(VEC)_{i}$, $C_{i}$ and $(VEC)_{i}$ stand for the atomic fraction and VEC value of element $i$, respectively. The corresponding VEC values of each element are listed in the table below.
    | Element | VEC |
    | :--- | :--- |
    | Al | 3 |
    | Co | 9 |
